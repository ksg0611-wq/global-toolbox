        ...
        <div className="p-6">
          ...
          <article className="mt-10 pt-6 border-t border-slate-150 dark:border-zinc-900 text-xs text-slate-500 dark:text-slate-400 space-y-4 text-left">
            ...
            <p className="leading-relaxed">
              How much do YouTubers actually make? Channels generate ad revenue through the YouTube Partner Program (YPP) using Google AdSense. Earnings are calculated based on **CPM (Cost Per Mille)**, which is the amount advertisers pay for every 1,000 views of an ad.
            </p>
            ...
            <p className="leading-relaxed">
              It is important to differentiate between **CPM** and **RPM (Revenue Per Mille)**. While CPM represents the gross cost paid by the advertiser, RPM represents the net earnings generated by the creator per 1,000 video views after YouTube's 45% revenue cut and accounting for non-monetized playbacks. This calculator estimates net revenue by setting CPM figures to average real-world yields.
            </p>
            <h3 className="text-xs font-bold uppercase tracking-wider text-slate-700 dark:text-slate-350 mt-4 mb-2">
              Factors Influencing Ad Earnings
            </h3>
            <ul className="list-disc pl-5 space-y-1.5">
              <li><strong>Content Niche:</strong> High-ticket categories like Finance, Technology, and Business attract high-paying advertisers, leading to a much higher CPM. Casual niches like gaming or lifestyle see relatively lower advertiser bids.</li>
              <li><strong>Audience Geography:</strong> Viewers located in Tier 1 countries (United States, United Kingdom, Canada, Australia) trigger premium ads with higher CPMs, while Tier 3 regions (India, parts of Africa and Southeast Asia) generate lower CPM rates due to local market advertising differences.</li>
              <li><strong>Video Length &amp; Mid-rolls:</strong> Videos longer than 8 minutes allow creators to insert mid-roll ads, increasing the overall ad frequency and potential revenue.</li>
            </ul>
          </article>
