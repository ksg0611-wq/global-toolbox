...
export const TOOLS = [
  ...
  },
  {
    ...
    description: 'Upload two thumbnail candidates and compare them side-by-side in a real YouTube-like feed mockup — desktop and mobile views. Zero server uploads.',
    category:    'YouTube',
    iconName:    'IconYoutube',
    badge:       'New',
    href:        '/tools/youtube-thumbnail-ab-tester',
    comingSoon:  false,
    openModal:   true,
  },
  {
    ...
    description: 'Build GA4-compatible UTM tracking URLs with smart auto-formatting. Auto-lowercase and space-to-dash helpers prevent the most common campaign data fragmentation mistakes.',
    category:    'Marketing',
    iconName:    'IconLink',
    badge:       'New',
  ...
  },
  {
    ...
    description: 'Real-time word, character & paragraph counter with reading and speaking time predictions. Includes SEO keyword density analysis for blog posts and video scripts.',
    category:    'Writing',
    iconName:    'IconFileText',
    badge:       'New',
