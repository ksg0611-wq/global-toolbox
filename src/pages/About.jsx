...
export default function About() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-12 md:py-20 text-slate-800 dark:text-zinc-200">
      <SEO
        title="About Us"
        description="Welcome to Global ToolBox, a high-performance hub of free, client-side web utility applications designed specifically for creators, developers, and digital marketers worldwide."
        url="/about"
      />
      ...
      <div className="space-y-6 text-sm md:text-base leading-relaxed text-slate-600 dark:text-zinc-400 font-medium">
        ...
        <p>
          To keep these tools 100% free and support our edge server infrastructure, we serve non-intrusive display advertisements through Google AdSense. We sincerely thank you for supporting this ad-supported platform.
        </p>
